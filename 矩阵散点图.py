...
try: 
    ...
    # 可能python 3.74. 就用不了这个方法吧 可能更加新的 py 有这个
    #  Uninstalling plotly-3.6.1:
    #   Successfully uninstalled plotly-3.6.1
    # 之前装的 也是
    # https://note.youdao.com/s/cxfLFUaW
    # Python 3.6.6 :: Anaconda, Inc.  但是 kaggle 上是 这个版本 可以,所以是不是版本降下去才对啊

import seaborn as sns
import matplotlib.pyplot as plt

end=time.time()
print("load moudle use ",end-start,"s")
...
# https://note.youdao.com/s/41apR0cT
